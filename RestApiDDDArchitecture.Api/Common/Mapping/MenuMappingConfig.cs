...
using RestApiDDDArchitecture.Contracts.Menus;
using RestApiDDDArchitecture.Domain.MenuAggregate;

using MenuSection = RestApiDDDArchitecture.Domain.MenuAggregate.Entities.MenuSection;
using MenuItem = RestApiDDDArchitecture.Domain.MenuAggregate.Entities.MenuItem;
